---
title: "The wedeploy.json"
description: "Configuring deployments, scaling and many other features can all be controlled from the wedeploy.json file."
...
All WeDeploy services use a `wedeploy.json` file to define the service's attributes and configurations.
